       ...
       /* private static bool RisUsed
        ...
        private static void Main(string[] args)
            ...
            private static void Game_OnGameLoad(EventArgs args)
            {
                ...
                Game.PrintChat("NoobAatrox by 1Shinigamix3");
            }
        private static void OnUpdate(EventArgs args)
        {
            Obj_AI_Hero m = TargetSelector.GetTarget(650, TargetSelector.DamageType.Physical);
        ...
        {
            Obj_AI_Hero m = TargetSelector.GetTarget(1075, TargetSelector.DamageType.Physical);
            if (orbwalker.ActiveMode == Orbwalking.OrbwalkingMode.Combo)
            {
