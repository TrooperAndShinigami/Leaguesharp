...
namespace NoobUdyr
{
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Game.PrintChat("NoobUdyr by 1Shinigamix3");
        }
        private static void OnUpdate(EventArgs args)
        {
            ...
            {
                Obj_AI_Hero m = TargetSelector.GetTarget(600/*right here i decided that the range should be 600*/, TargetSelector.DamageType.Physical);
